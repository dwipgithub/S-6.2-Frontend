...
const FormTambahRL310 = () => {
    ...
    const getRLTigaTitikTigaTemplate = async () => {
        try {
            const response = await axiosJWT.get('/apisirs/jeniskegiatan?rlid=10', {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            })
    ...
    const Simpan = async (e) => {
        ...
        try {
            ...
            const result = await axiosJWT.post('/apisirs/rltigatitiksepuluh', {
                                ...
                                {dataRL.map((value, index) => {
                                    return (
                                        <tr key={value.id}>
                                            ...
                                            <td>
                                                <input type="text" name="jenisKegiatan" className="form-control" value={value.jenisKegiatan} disabled={true} onFocus={handleFocus} />
                                            </td>
