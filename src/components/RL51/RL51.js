...
const RL51 = () => {
    ...
    const Cari = async (e) => {
        ...
        try {
            ...
            const results = await axiosJWT.get('/apisirs/rllimatitiksatu',
                customConfig)
            ...
            // console.log(dataRLLimaTitikSatuDetails)
            // console.log(dataRL)
            setSpinner(false)
        } catch (error) {
            console.log(error)
    ...
    const hapusData = async(id) => {
        ...
        try {
            await axiosJWT.delete(`/apisirs/rllimatitiksatu/${id}`,
                customConfig)
            setDataRL((current) =>
        ...
        <div className="container" style={{marginTop: "70px"}}>
                ...
                <div className="row mt-3 mb-3">
                    <div className="col-md-12">
                        <Link to={`/rl51/tambah/`} className='btn btn-info' style={{fontSize:"18px", backgroundColor: "#779D9E", color: "#FFFFFF"}}>
                            {/* <AiFillFileAdd size={30} style={{color:"gray",cursor: "pointer"}}/>
                            <span style={{color:"gray"}}>RL 5.1 -  Pengunjung</span> */}
                            +
                        </Link>
                        <span style={{color:"gray"}}>RL 5.1 -  Pengunjung</span>
                                        ...
                                        <tr key={value.id}>
                                            ...
                                            <td style={{textAlign: "center", verticalAlign: "middle"}}>
                                                ...
                                                {/* <RiDeleteBin5Fill  size={20} onClick={(e) => hapus(value.id)} style={{color: "gray", cursor: "pointer", marginRight: "5px"}} /> */}
                                                    ...
                                                    <Link to={`/rl51/ubah/${value.id}`} className='btn btn-warning' style={{margin: "0 5px 0 0", backgroundColor: "#CFD35E", border: "1px solid #CFD35E", color:"#FFFFFF"}} >
                                                        U
                                                    </Link>
                                                </div>
                                            </td>
