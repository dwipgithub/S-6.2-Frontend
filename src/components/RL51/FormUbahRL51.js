...
export const FormUbahRL51 = () => {
    ...
    const updateDataRLLimaTitikSatu = async (e) => {
        e.preventDefault();
        setSpinner(true)
        ...
        try {
            ...
            await axiosJWT.patch('/apisirs/rllimatitiksatudetail/' + id, {
                jumlah,
            }, customConfig);
            setSpinner(false)
    ...
    const getRLLimaTitikSatuById = async () => {
        setSpinner(true)
        const response = await axiosJWT.get('/apisirs/rllimatitiksatudetail/'+ id, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        })
        ...
        // setJeniskegiatan(response.data.data.rl_lima_titik_satu_id);
    ...
    return (
        <div className="container" style={{marginTop: "70px"}}>
            <form onSubmit={updateDataRLLimaTitikSatu}>
                <div className="row">
                ...
                <div className="row mt-3 mb-3">
                    <div className="col-md-12">
                        ...
                        <Link to={`/rl51/`} className='btn btn-info' style={{fontSize:"18px", backgroundColor: "#779D9E", color: "#FFFFFF"}}>
                            ...
                            <span style={{color: "gray"}}>Ubah data RL 5.1 -  Pengunjung</span> */}
                            &lt;
                        </Link>
